...
const voteModule = sdk.getVoteModule(
  "0x7518630B02A4076F71A396956E6cc8E75Df64496",
);
...
const App = () => {
  ...
  //fancy function to shorten someones wallet address
  ...
  //This useEffect grabs all addresses of the members holding our NFT
  useEffect(() => {
    if (!hasClaimedNFT) {
      return;
    }
    //just like with 7-airdrop-token.js, grab holders of NFT using tokenID 0
    bundleDropModule
  ...
  useEffect(() => {
    // We pass signer to the sdk, which enables us to interact with the deployed contract.
    ...
    if (hasClaimedNFT) {
      return (
        <div className="member-page">
          <h1>🎥 MovieNightDAO Member Page</h1>
